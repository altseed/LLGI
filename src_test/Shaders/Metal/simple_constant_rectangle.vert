...
VS_OUTPUT _main(thread const VS_INPUT& _input, constant CB& _31)
{
    VS_OUTPUT _output;
    _output.Position = float4(_input.Position, 1.0) + _31.offset;
    _output.UV = _input.UV;
    _output.Color = _input.Color;
    return _output;
}

vertex main0_out main0(main0_in in [[stage_in]], constant CB& _31 [[buffer(0)]])
{
    main0_out out = {};
    VS_INPUT _input;
    ...
    VS_OUTPUT flattenTemp = _main(param, _31);
