...
layout(set = 1, binding = 1) uniform sampler2D Sampler_g_sampler1;
layout(set = 1, binding = 2) uniform sampler2DArray Sampler_g_sampler2;
layout(set = 1, binding = 3) uniform sampler3D Sampler_g_sampler3;
