...
private:
	...
	*/
	...
	bool ValidateLayers(std::vector<const char*> requiredLayers, const std::vector<VkLayerProperties>& properties);

	std::vector<const char*> GetOptimalLayers(const std::vector<VkLayerProperties>& properties);
